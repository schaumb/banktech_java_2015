...
public class ExplodeCellRequest implements Equals, HashCode, ToString
{
     ...
     * 
     */
    public ExplodeCellRequest(final int unit, final WsDirection direction) {
        this.unit = unit;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExplodeCellRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ExplodeCellRequest that = ((ExplodeCellRequest) object);
        {
            int lhsUnit;
