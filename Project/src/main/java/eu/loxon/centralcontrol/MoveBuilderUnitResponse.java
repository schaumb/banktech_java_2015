...
public class MoveBuilderUnitResponse implements Equals, HashCode, ToString
{
     ...
     * 
     */
    public MoveBuilderUnitResponse() {
        super();
    }
     ...
     * 
     */
    public MoveBuilderUnitResponse(final CommonResp result) {
        this.result = result;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MoveBuilderUnitResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MoveBuilderUnitResponse that = ((MoveBuilderUnitResponse) object);
        {
