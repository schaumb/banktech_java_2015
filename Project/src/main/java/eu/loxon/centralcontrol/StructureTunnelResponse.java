...
@XmlRootElement(name = "structureTunnelResponse")
public class StructureTunnelResponse implements Equals, HashCode, ToString
{
     ...
     * 
     */
    public StructureTunnelResponse() {
        super();
    }
     ...
     * 
     */
    public StructureTunnelResponse(final CommonResp result) {
        this.result = result;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof StructureTunnelResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final StructureTunnelResponse that = ((StructureTunnelResponse) object);
        {
