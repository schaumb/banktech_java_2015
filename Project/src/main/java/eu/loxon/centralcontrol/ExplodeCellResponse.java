...
public class ExplodeCellResponse implements Equals, HashCode, ToString
{
     ...
     * 
     */
    public ExplodeCellResponse(final CommonResp result) {
        this.result = result;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExplodeCellResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ExplodeCellResponse that = ((ExplodeCellResponse) object);
        {
