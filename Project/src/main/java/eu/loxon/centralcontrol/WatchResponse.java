...
public class WatchResponse implements Equals, HashCode, ToString
{
     ...
     * 
     */
    public WatchResponse(final List<Scouting> scout, final CommonResp result) {
        this.scout = scout;
        this.result = result;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof WatchResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final WatchResponse that = ((WatchResponse) object);
        {
