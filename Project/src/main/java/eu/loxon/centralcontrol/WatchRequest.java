...
public class WatchRequest implements Equals, HashCode, ToString
{
     ...
     * 
     */
    public WatchRequest(final int unit) {
        this.unit = unit;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof WatchRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final WatchRequest that = ((WatchRequest) object);
        {
            int lhsUnit;
