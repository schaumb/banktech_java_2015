...
@XmlRootElement(name = "structureTunnelRequest")
public class StructureTunnelRequest implements Equals, HashCode, ToString
{
     ...
     * 
     */
    public StructureTunnelRequest(final int unit, final WsDirection direction) {
        this.unit = unit;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof StructureTunnelRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final StructureTunnelRequest that = ((StructureTunnelRequest) object);
        {
            int lhsUnit;
